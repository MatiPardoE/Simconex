...
void process_command(const String &string_buffer, pH device_list[], uint8_t device_list_len, pH* &default_board){
	pH* device_list_ptrs[32]; //making this arbitrarily 32 sensors long
