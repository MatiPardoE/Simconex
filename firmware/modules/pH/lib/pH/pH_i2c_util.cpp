#include <pH_i2c_util.h>

// prints the boards name and I2C address
void print_device_info(pH &Device) {
...
void print_success_or_error(pH &Device, const char* success_string) {
...
void receive_and_print_reading(pH &Device) {              // function to decode the reading after the read command was issued
